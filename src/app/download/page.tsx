  ...
  return (
    <div className="pt-48 pb-40 bg-black min-h-screen">
      <div className="grid-container mb-40">
        ...
        <h2 className="text-5xl md:text-7xl font-bold tracking-tight mb-12">Deploy Core.</h2>
      ...
      <div className="grid-container grid grid-cols-1 lg:grid-cols-3 gap-px bg-[#27272a] border border-[#27272a] mb-60">
        {/* Desktop Client */}
        <div className="lg:col-span-2 bg-black p-20 flex flex-col md:flex-row gap-20">
          <div className="md:w-1/2">
            <div className="flex items-center gap-6 mb-12">
              <div className="w-10 h-10 border border-[#27272a] flex items-center justify-center">
                <Monitor className="w-4 h-4 text-white" />
              </div>
              <h3 className="text-3xl font-bold tracking-tight">Desktop Client</h3>
            </div>
        ...
        <div className="bg-black p-px flex flex-col gap-px bg-[#27272a]">
          ...
          <div className="bg-black p-12 flex-1 flex flex-col">
            ...
            <p className="text-xs text-[#71717a] mb-12 font-medium leading-relaxed">Native Python installation for developers and infrastructure researchers.</p>
            <div className="mt-auto bg-zinc-950 p-6 border border-[#27272a] font-mono text-[10px] text-white">
